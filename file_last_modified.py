...
uid: '',
email: '',
sess_id: '275405684996960072126634628599207517028',
root_ns: 0,
SVN_REV: '33511',
TOKEN: '',
IS_PROD: 1,
...
RK_TEST2_ENABLED: 0,
RK_TEST3_ENABLED: 0,
LIGHT_LINK_TEST_ENABLED: 0,
shmodal_contact_importer_enabled: 0,
upload_debug: false,
...
</script><script defer="defer" src="/static/_32jHrOTiHHMywna-/javascript/compiled/dropbox-mini.js" type="text/javascript" async="async"></script><style type="text/css">.hny-tzibsi { display: none; }</style><!--[if lte IE 8]><style>.sick-input input[type=password] {
...
overflow: auto;
                }</style><link href="/static/33511/css/syntax.css" type="text/css" rel="stylesheet" /><script>
...
<div class="error-plain-text" style="display:none;">
  ...
  <div id="new-password-field" class="sick-input">
    ...
    <script type="text/javascript" charset="utf-8" src="/static/33511/javascript/password_strength.js">
    </script>
    <script type="text/javascript">
      on_script_loaded(function () {
...
document.observe('script:loaded', function() {
SharingModel.init('file\x5flast\x5fmodified\x2epy', Util.from_json('\x7b\x22item\x5fid\x22\x3a\x20\x22\x22\x2c\x20\x22secure\x5fhash\x22\x3a\x20\x22\x22\x2c\x20\x22subpath\x22\x3a\x20\x22\x22\x2c\x20\x22tkey\x22\x3a\x20\x2203c7xpg0xc9gubq\x22\x7d'))
SharingModel.init_file()
$('emsnippet-0f96e46ae47c62e2').innerHTML = 'file\x5flast\x5fmodified\x2epy'.em_snippet(50, 0.750).escapeHTML();
$('emsnippet-e951da94007ec07e').innerHTML = 'file\x5flast\x5fmodified\x2epy'.em_snippet(20, 0.750).escapeHTML();
$('emsnippet-7370563713173abc').innerHTML = 'file\x5flast\x5fmodified\x2epy'.em_snippet(20, 0.750).escapeHTML();
FilePreview.init_text('https\x3a\x2f\x2fdl\x2edropbox\x2ecom\x2fs\x2f03c7xpg0xc9gubq\x2ffile\x5flast\x5fmodified\x2epy', 1)                        });
